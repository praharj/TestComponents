...
function IdleClicker() {
    ...
    return (
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title id="contained-modal-title-vcenter">Stats</Modal.Title>
        </Modal.Header>
        <Modal.Body style={{ textAlign: "center" }}>
          <div>
            <Badge className="stats-badge">Parameter 1</Badge>:
            <Badge
              className="stats-badge"
              style={{ backgroundColor: "yellow", marginLeft: "1%" }}
            >
              value 1
            </Badge>
          ...
          <div>
            <Badge className="stats-badge">Parameter 2</Badge>:
            <Badge
              className="stats-badge"
              style={{ backgroundColor: "yellow", marginLeft: "1%" }}
            >
          ...
          <div>
            <Badge className="stats-badge">Parameter 3</Badge>:
            <Badge
              className="stats-badge"
              style={{ backgroundColor: "yellow", marginLeft: "1%" }}
            >
          ...
          <div>
            <Badge className="stats-badge">Parameter 4</Badge>:
            <Badge
              className="stats-badge"
              style={{ backgroundColor: "yellow", marginLeft: "1%" }}
            >
          ...
          <div>
            <Badge className="stats-badge">Parameter 5</Badge>:
            <Badge
              className="stats-badge"
              style={{ backgroundColor: "yellow", marginLeft: "1%" }}
            >
  ...
  function Managers(props) {
    return (
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title id="contained-modal-title-vcenter">Managers</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <div className="manager">
            <img
              ...
              src="http://images5.fanpop.com/image/photos/31600000/Gus-T-T-Showbizand-etc-Smooth-psych-31699715-185-272.jpg"
            />
            <h4>Gus TT -</h4>
            <h4 id="managerof">Manager of Himashu</h4>
            <p>
              Burton "Gus" Guster is a fictional character on Psych played by
              American actor Dulé Hill.{" "}
            </p>
            <div style={{ textAlign: "center" }}>
              <h5>Cost : $30000</h5>
  ...
  return (
    <div id="idleclick">
      {showStats ? (
        <>
          <Stats show={showStats} onHide={() => setShowStats(false)} />
        </>
      ) : (
        <></>
      )}
      {showManagers ? (
        <>
          <Managers show={showManagers} onHide={() => setShowManagers(false)} />
        </>
      ) : (
        <></>
      )}
